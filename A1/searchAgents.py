...
def cornersHeuristic(state, problem):
    ...
    "*** YOUR CODE HERE ***"
    # heuristic is the shortest manhattan distance to a missing corner + to shortest distrance from 1 missing corner to the next
    ...
    count = len(missingCorners)
    sumDistCorners = 0

    if count == 4:
        dist1 = (abs(missingCorners[0][0] - missingCorners[1][0]) + abs(missingCorners[0][1] - missingCorners[1][1]) )
        dist2 = (abs(missingCorners[1][0] - missingCorners[2][0]) + abs(missingCorners[1][1] - missingCorners[2][1]) )
        dist3 = (abs(missingCorners[2][0] - missingCorners[3][0]) + abs(missingCorners[2][1] - missingCorners[3][1]) )
        sumDistCorners = min(dist1,dist2,dist3)
    elif count == 3:
        dist1 = (abs(missingCorners[0][0] - missingCorners[1][0]) + abs(missingCorners[0][1] - missingCorners[1][1]) )
        dist2 = (abs(missingCorners[1][0] - missingCorners[2][0]) + abs(missingCorners[1][1] - missingCorners[2][1]) )
        sumDistCorners = min(dist1,dist2)
    elif count ==2:
        sumDistCorners = (abs(missingCorners[0][0] - missingCorners[1][0]) + abs(missingCorners[0][1] - missingCorners[1][1]) )
    
    hCost += sumDistCorners
    return hCost
